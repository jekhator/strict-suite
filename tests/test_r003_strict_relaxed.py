...
def test_r003_strict_mode_flags_repr_false():
...
def test_r003_strict_mode_accepts_no_repr():
...
def test_r003_relaxed_mode_ignores_repr_false():
...
def test_r003_relaxed_mode_checks_frozen_slots():
...
def test_r003_relaxed_mode_accepts_frozen_slots_only():
