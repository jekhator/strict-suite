...
def test_r003_canonical_mode_flags_repr_false(tmp_path):
...
def test_r003_canonical_mode_allows_no_repr(tmp_path):
...
def test_r003_legacy_mode_requires_repr_false(tmp_path):
...
def test_r003_legacy_mode_allows_repr_false(tmp_path):
