...
class TestR002TagSeparatorFormat:
    """Test suite for related functionality."""

    def test_r002_tag_separator_format_in_message(self, tmp_path):
...
""")
    ...
    def test_tag_separator_uses_colon_not_em_dash(self, tmp_path):
