...
@pytest.fixture
def config():
    """Create a test config with service_paths pattern."""
    return Config(
...
def test_service_test_file_exempt_from_r001_r004_r006():
...
def test_production_service_file_still_flagged_for_r001_r004_r006():
