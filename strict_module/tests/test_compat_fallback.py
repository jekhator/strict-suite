...
class TestCompatFallback:
    ...
    def test_config_reads_strict_module_first(self):
...
""")
    ...
    def test_config_falls_back_to_dto_strict(self):
...
""")
    ...
    def test_config_uses_defaults_when_no_sections(self):
    ...
    def test_baseline_prefers_strict_module_file(self):
    ...
    def test_baseline_falls_back_to_dto_strict_file(self):
    ...
    def test_baseline_returns_empty_when_no_files_exist(self):
